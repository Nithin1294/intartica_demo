        ...
        return (
            <div className='pl-5'>
                ...
                <div className='recent-container'>
                    <h1 className='black-heading'>We will let our <span className='red-heading'> Masterpieces, </span> speak and cuddle your <span className='red-heading'>imaginations</span> for us!</h1>
                </div>
                <div className='pl-5'>
